    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "translate-x-[-50%] translate-y-[-50%] gap-4 rounded-base p-6 shadow-lg",
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className={cn(
              ...
              "text-neutral-400 hover:text-neutral-0 cursor-pointer"
            )}
          >
            <XIcon />
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "text-lg leading-none font-semibold text-neutral-0",
        className
      )}
      {...props}
    />
